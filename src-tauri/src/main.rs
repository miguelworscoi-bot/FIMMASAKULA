...
const ESC_INIT: &[u8] = &[0x1B, 0x40];                            // ESC @ (Inicializar impressora)
const ESC_DRAWER_PULSE: &[u8] = &[0x1B, 0x70, 0x00, 0x19, 0xFA]; // ESC p 0 25 250 (Abrir gaveta Pino 2)
const GS_CUT_PAPER: &[u8] = &[0x1D, 0x56, 0x00];                  // GS V 0 (Corte total do papel)
...
fn main() {
    tauri::Builder::default()
        ...
        .expect("Erro ao inicializar aplicativo Tauri Masakula POS");
}
